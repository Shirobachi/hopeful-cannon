...
curl -s https://raw.githubusercontent.com/Shirobachi/super-duper-octo-spork/master/Documents/Linux/Backup/super-duper-octo-spork.service -o /tmp/super-duper-octo-spork.service
